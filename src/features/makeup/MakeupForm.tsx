      ...
      <Card>
        <div className="space-y-6">
          <div className="space-y-3 text-center">
            ...
            <p>
              <a
                className="text-gold-600 underline decoration-gold-400 underline-offset-2 hover:text-gold-700"
          ...
          <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
            <div className="form-field">
              ...
              <input className="input-field" id="makeup-name" {...register('name')} />
              {errors.name && (
            ...
            <div className="form-field">
              <p className="label">Qué necesitan</p>
