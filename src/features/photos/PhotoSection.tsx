      ...
      <Card>
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <input
              accept="image/*"
              className="mt-1 block w-full text-sm text-stone-600 file:mr-4 file:rounded-lg file:border-0 file:bg-sand-100 file:px-4 file:py-2 file:text-stone-700"
              id="photoFile"
              type="file"
        ...
        <div className="mt-8 rounded-xl border border-sand-200 bg-sand-50/50 p-4 text-center">
          <p className="text-sm font-medium text-stone-700">Compartir por enlace o QR</p>
          <p className="mt-1 text-sm text-stone-600">
            Puedes compartir esta página con otros invitados para que suban sus fotos:
          </p>
          <a className="mt-2 inline-block text-gold-600 underline" href={sharePhotosUrl}>
